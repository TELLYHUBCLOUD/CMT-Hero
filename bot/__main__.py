...
bot_stats = f'<b><i><u>Pea Masamba Bot Statistics</u></i></b>\n\n'\
...
async def send_sys_stats(_, query):
    buttons = ButtonMaker()
    sys_stats = f'<b><i><u>Pea Masamba System Statistics</u></i></b>\n\n'\
...
async def send_bot_limits(_, query):
    ...
    bot_limit = f'<b><i><u>Pea Masamba Bot Limitations</u></i></b>\n' \
